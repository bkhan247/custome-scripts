    ...
    $jq321("body").on("click", "button[type='submit'][name='checkout']", function (e) {
     ...
     function stockCountdown(responseStock) {
		...
		if (responseStock.above_cart == 1) {
			 if (selectorStock1.length == 1) {console.log("In the first selector");
				selectorStock1.prepend(responseStock.view);
			} else if (selectorStock2.length == 1) {console.log("In the second selector");
				selectorStock2.prepend(responseStock.view);
			} else if (selectorStock3.length == 1) {console.log("In the third selector");
				$jq321(responseStock.view).insertBefore(selectorStock3);
			} else if (selectorStock4.length == 1) {console.log("In the fourth selector");
				selectorStock4.prepend(responseStock.view);
			} else if (selectorStock5.length == 1) {console.log("In the fifth selector");
				$jq321(responseStock.view).insertBefore(selectorStock5);
			} else if (selectorStock6.length == 1) {console.log("In the sixth selector");
